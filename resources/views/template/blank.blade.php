...
<html :class="{ 'theme-dark': dark }" x-data="data()" lang="en">
  <head>
    ...
    <title>I-Seuramoe</title>
    <link
      href="https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700;800&display=swap"
      rel="stylesheet"
    />
    <link rel="stylesheet" href="{{ asset('css/tailwind.output.css') }}" />
    <link href="{{ asset('css/styles.css') }}" rel="stylesheet"> <!-- Link your CSS file -->
    <script
    ...
    <script src="https://kit.fontawesome.com/ea01b8db59.js" crossorigin="anonymous"></script>
    @yield('css')
  </head>
  <body >
    <div
    ...
    >
        ...
        <div class="py-4 text-gray-500 dark:text-gray-400">
          ...
          <ul class="mt-6">
            <li class="relative px-6 py-3">
              ...
              <a
                class="inline-flex items-center w-full text-sm font-semibold text-white transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
                href="/dashboard"
              >
                <svg
                  class="w-5 h-5"
          ...
          <ul>
            ...
            >
              ...
              ></path>
                ...
                <span class="ml-4">Tentang Seuramoe</span>
              </a>
            </li> --}}
            ...
            <li class="relative px-6 py-3">
              ...
              <span class="ml-4">Manage Data</span>
            </a>
            </li>
            @endif
      ...
      <div class="flex flex-col flex-1 ">
        <header class="z-10 py-4 bg-white shadow-md dark:bg-gray-800 navbar">
          <div
          ...
          >
            ...
            <!-- Search input -->
            <div class="search-container flex justify-center flex-1 lg:mr-32 invisible">
              @yield('search')
              </div>
            ...
            <ul class="flex items-center flex-shrink-0 space-x-6">
              ...
              <li class="relative">
                <button
                  ...
                  aria-haspopup="true"
                >
                  <div class="text-white transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200" style="display: flex; gap: 10px; justify-content: space-between; align-items: center; border-radius: 5px; height:3em; width:3em;">
                    <span class="text-sm font-semibold ">Welcome, {{ auth()->user()->name }}</span>
                    <i class="fa-regular fa-square-caret-down"></i>                  </div>
        ...
        <main class="h-full pb-16 overflow-y-auto background-image-1">
